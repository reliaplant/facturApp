  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {/* Banner de pago pendiente como en mi-contabilidad */}
        <motion.div
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            ...
            <div>
              <p className="text-xs font-semibold">Tienes pendiente el pago de Enero 2026</p>
              <p className="text-[10px] opacity-80">Monto a pagar: $12,450.00</p>
            </div>
          </div>
          <div className="flex gap-2">
            <button className="flex-1 text-[10px] bg-emerald-600 py-1.5 rounded-lg">📥 Línea de Captura</button>
            <button className="flex-1 text-[10px] bg-white text-emerald-700 py-1.5 rounded-lg font-medium">¿Ya la pagaste?</button>
          </div>
        </motion.div>
